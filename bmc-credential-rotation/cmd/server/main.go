...
import (
	...
	_ "github.com/example/bmc-credential-rotation/pkg/apiversion"
	"github.com/openchami/fabrica/pkg/versioning"
	 ...
	 "github.com/example/bmc-credential-rotation/internal/storage/ent/migrate"
	...
	. "github.com/example/bmc-credential-rotation/internal/middleware"
	

	
	"github.com/openchami/fabrica/pkg/reconcile"
	"github.com/example/bmc-credential-rotation/pkg/reconcilers"
...
var rootCmd = &cobra.Command{
	Use:   "bmc-credential-rotation",
	Short: "",
	Long:  `bmc-credential-rotation - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the bmc-credential-rotation server",
	Long:  `Start the bmc-credential-rotation HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.bmc-credential-rotation.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".bmc-credential-rotation")
	}

	// Environment variables
	viper.SetEnvPrefix("BMC-CREDENTIAL-ROTATION")
	viper.AutomaticEnv()
...
func runServer(cmd *cobra.Command, args []string) error {
	log.Printf("Starting bmc-credential-rotation server...")
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "bmc-credential-rotation.resource"
	}
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"bmc-credential-rotation"}`))
}
...
var versionCmd = &cobra.Command{
	...
	Long:  `Print the version number of bmc-credential-rotation`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("bmc-credential-rotation v1.0.0")
	},
}
